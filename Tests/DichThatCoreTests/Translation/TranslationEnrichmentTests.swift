...
func localizedContextMerge() throws {
    ...
    #expect(TranslationEnrichmentPolicy.maximumRequests == 3)
    #expect(TranslationEnrichmentPolicy.requestCount(mode: .dictionary, hasContextBatch: true) == 3)
    #expect(TranslationEnrichmentPolicy.requestCount(mode: .dictionary, hasContextBatch: false) == 2)
